...
int main(int argc,char *argv[])
{
    ...
    //printf("Starting matrix-matrix multiplication example with %d threads. M= %d, K= %d, N= %d, chunk= %d, LEVEL= %d\n", nthreads, M,K,N,chunk,LEVEL);

	#pragma omp parallel private(i, j, k, tid, thread_start_time, thread_end_time)
	{
